...
namespace Appointmentv3.BL
{
    public class BusinessLayerAsync : IBusinessLayerAsync
    {
        ...
        public async Task<Appointment> createAppointmentAsync(CreatingAppointmentDTO creatingAppointment, int h, int d, int m, int y)
        {
        ...
        public async Task<Appointment> editAppointmentAsync(int appointmentID, Appointment editedAppointment, int h, int d, int m, int y)
        {
